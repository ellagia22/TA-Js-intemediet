...
//jawab : pada fun1 berjalan mengembalikan objek dan pada fun2 tidak mengembalikan objek atau sesuatu apapun
// 2. Apakah hasil dari fun1 dan fun2 itu sama? 
// jawab : akan berbeda karena tugas dari fun 1 dan fun 2 saat dijalankan berbeda
// 3. Buatlah sebuah alasan dari poin ke-2, mengapa baris kode tersebut menampilkan hasil baik itu sama ataupun tidak. 
// jawaban : Karena this pada fun1 akan merujuk pada function (fun1 adalah function) sedangkan fun2 tidak akan merujuk pada apa-apa
// const obj = {
//   fun1: function() {
